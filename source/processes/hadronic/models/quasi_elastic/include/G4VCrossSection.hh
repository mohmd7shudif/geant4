...
//
//
// $Id: G4VCrossSection.hh,v 1.1 2009-11-16 18:15:42 mkossov Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
//
// GEANT4 virtual class: G4VCrossSection -- header file
...
//
// Original description by M.K. follows.
...
// G4VCrossSection class. In the G4QCollision class the general G4VCrossSection*
...
//  static G4VCrossSection* GetPointer(); // Gives a pointer to the singletone
// static function, which is defined in the *.cc file as
//     // Returns Pointer to the G4VCrossSection class
//     G4VCrossSection* G4VCrossSection::GetPointer()
//     {
//       static  G4QXCrossSection theCrossSection; //***Static body of the Cross Section***
//       return &theCrossSection;
//     }
// the line
//   //virtual static G4VCrossSection* GetPointer(); // Gives a pointer to the singletone
...
#ifndef G4VCrossSection_h
#define G4VCrossSection_h 1
...
protected:
  ...
  G4VCrossSection() {;} // for each particle a separate instance of G4QCollision should be
                         // used (and inside use a separate instance of G4Q*CrossSection)

public:
  virtual ~G4VCrossSection() {;}// for each particle separate instance of G4QXCrossSection
